        ...
        <div className="container">
          ...
          <div className="cta-final__content" data-animate>
            ...
            <div className="cta-final__buttons">
              <a href={getWhatsAppUrl('Hola, me gustaría agendar una cita con un especialista')} className="btn btn--whatsapp btn--large" target="_blank" rel="noopener noreferrer">
